...
graph TD
    ...
    B --> B3[Developer Setup]
    B --> B4[Administrator Guide]
    
    C --> C1[Product Capabilities]
    C --> C2[User Guide]
    C --> C3[Client Portal Guide]
    C --> C4[Production Launch Plan]
    ...
    G --> G3[Client Success System]
    G --> G4[Market Intelligence]
    
    H --> H1[CPA Workflow Optimization]
